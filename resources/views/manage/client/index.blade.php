...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div>
                <div>
                    <a href="{{route('client.create')}}" class="btn btn-primary waves-effect waves-light mb-3"><i
                            class="mdi mdi-plus mr-1"></i> Add Client</a>
                </div>
                    ...
                    <table class="table table-centered datatable dt-responsive nowrap table-check table-card-list"
                        ...
                        <tbody>
                            ...
                            <tr id="row-{{$user->id}}">
                                ...
                                <td>
                                    @if($user->photo)
                                    <img src="{{asset('public/assets/profile/'.$user->photo)}}" alt="{{$user->name}}"
                                ...
                                <td>
                                    <a href="{{route('client.edit', $user->id)}}" class="px-3 text-primary" data-toggle="tooltip"
