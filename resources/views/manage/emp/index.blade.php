...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div>
                <div>
                    <a href="{{route('emp.create')}}" class="btn btn-primary waves-effect waves-light mb-3"><i
                            class="mdi mdi-plus mr-1"></i> Add Employee</a>
                </div>
                    ...
                    <table class="table table-centered datatable dt-responsive nowrap table-check table-card-list"
                        ...
                        <tbody>
                            ...
                            <tr id="row-{{$user->id}}">
                                ...
                                <td>{{$user->email}}</td>
                                <td>
                                    <a href="{{route('emp.edit', $user->id)}}" class="px-3 text-primary" data-toggle="tooltip"
