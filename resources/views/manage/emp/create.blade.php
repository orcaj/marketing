...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form class="custom-validation" action="{{route('emp.store')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3">
                                <div class="custom-control custom-checkbox mb-3">
                                    <input type="checkbox" name="client[]" class="custom-control-input" id="check{{$client->id}}" value="{{$client->id}}" >
                                    <label class="custom-control-label" for="check{{$client->id}}">{{$client->name}}</label>
                                </div>
                            </div>
                            @endforeach
