...
<div class="row">
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            <div>
               <form action="{{ route('media.update', $digital->id)}}" enctype="multipart/form-data" method="post" id="submit_form">
                  @csrf
                  @method('put')
                  ...
                  <a class="btn btn-primary mt-2" href="{{route('media.index')}}">{{__('Cancel')}}</a>
