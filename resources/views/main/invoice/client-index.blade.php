                  ...
                  <div class='product-box' id="{{$digital->id}}">
                     <div class='product-img pt-4 px-4'>
                        ...
                        <a href="javascript:void(0)">
                           ...
                           <img src="{{asset('public/upload/invoice/'.$digital->full_name)}}" alt='' class='img-fluid mx-auto p-img'>
                           <img src="{{asset('public/upload/invoice/'.$digital->full_name)}}" alt='' class='img-fluid mx-auto p-h-img'>
                        ...
                        <ul class='list-unstyled mb-0 text-muted product-color'>
                           <li class='text-center'>
                              <a href="{{ asset('public/upload/invoice/'.$digital->full_name) }}" target='_blank' class='btn btn-primary'><i class='uil uil-eye font-size-18'></i></a>
                           </li>
                           <li class='text-center'>
                              <a href="{{ asset('public/upload/invoice/'.$digital->full_name)}}" target='_blank' class='btn btn-primary' download><i class='uil-arrow-circle-down font-size-18'></i></a>
                           </li>
                           <li>
                        </ul>
                     </div>
