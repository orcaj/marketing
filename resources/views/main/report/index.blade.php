      ...
      <form>
         <div class="row">
            <div class="{{auth()->user()->role == 'emp' ? 'col-8' : 'col-5'}}">
               <a href="{{route('report.create')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-plus mr-1"></i> @lang('general.Add')</a>
            </div>
         ...
         <table class="table table-centered datatable dt-responsive nowrap table-check table-card-list" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
            ...
            <tbody>
               ...
               <tr id="row-{{$digital->id}}">
                  ...
                  <td>{{$key+1}}</td>
                  <td>
                     {{-- <img src="{{ asset('public/upload/report/'.$digital->name) }}" alt="{{$digital->name}}" loading="lazy"
                  ...
                  <td><a class="btn btn-primary waves-effect waves-light" href="{{ asset('public/upload/report/'.$digital->full_name) }}" download>@lang('general.Download') </a></td>

                  <td>
                     <a href="{{route('report.edit', $digital->id)}}" class="px-3 text-primary" data-toggle="tooltip" data-placement="top" title="Edit"><i class="uil uil-pen font-size-18"></i></a>
                     ...
                     <a class="px-3 text-primary" href="{{ asset('public/upload/report/'.$digital->full_name) }}" target="_blank"> <i class="uil uil-eye font-size-18"></i></a>
                  </td>
               </tr>
               @endforeach
